						...
						values: [
							{
								...
								options: [
									...
									{ name: 'ImageDescription', value: 'ImageDescription' },
									{ name: 'Make (Camera)', value: 'Make' },
									{ name: 'Model (Camera)', value: 'Model' },
									{ name: 'Software', value: 'Software' },
									{ name: 'UserComment', value: 'UserComment' },
									// IPTC Tags
									{ name: 'By-line', value: 'By-line' },
									{ name: 'By-lineTitle', value: 'By-lineTitle' },
									{ name: 'Caption-Abstract', value: 'Caption-Abstract' },
									{ name: 'Category', value: 'Category' },
									{ name: 'City', value: 'City' },
									{ name: 'CopyrightNotice', value: 'CopyrightNotice' },
									{ name: 'Country-PrimaryLocationName', value: 'Country-PrimaryLocationName' },
									{ name: 'Credit', value: 'Credit' },
									{ name: 'Headline', value: 'Headline' },
									{ name: 'ObjectName', value: 'ObjectName' },
									{ name: 'OriginalTransmissionReference', value: 'OriginalTransmissionReference' },
									{ name: 'Province-State', value: 'Province-State' },
									{ name: 'Source', value: 'Source' },
									{ name: 'SpecialInstructions', value: 'SpecialInstructions' },
									{ name: 'Sub-location', value: 'Sub-location' },
									{ name: 'SupplementalCategories', value: 'SupplementalCategories' },
									...
									{ name: 'XMP-xmpRights:UsageTerms', value: 'XMP-xmpRights:UsageTerms' },
									{ name: 'XMP-xmpRights:WebStatement', value: 'XMP-xmpRights:WebStatement' },
									// XMP Photoshop
									{ name: 'XMP-photoshop:AuthorsPosition', value: 'XMP-photoshop:AuthorsPosition' },
									{ name: 'XMP-photoshop:CaptionWriter', value: 'XMP-photoshop:CaptionWriter' },
									...
									{ name: 'XMP-photoshop:DateCreated', value: 'XMP-photoshop:DateCreated' },
									...
									{ name: 'XMP-photoshop:TransmissionReference', value: 'XMP-photoshop:TransmissionReference' },
									// PDF Tags
									{ name: 'PDF:Author', value: 'PDF:Author' },
									{ name: 'PDF:CreationDate', value: 'PDF:CreationDate' },
									{ name: 'PDF:Creator', value: 'PDF:Creator' },
									{ name: 'PDF:Keywords', value: 'PDF:Keywords' },
									{ name: 'PDF:ModDate', value: 'PDF:ModDate' },
									{ name: 'PDF:Producer', value: 'PDF:Producer' },
									{ name: 'PDF:Subject', value: 'PDF:Subject' },
									{ name: 'PDF:Title', value: 'PDF:Title' },
									// GPS Tags
									{ name: 'GPSLatitude', value: 'GPSLatitude' },
									{ name: 'GPSLatitudeRef', value: 'GPSLatitudeRef' },
									{ name: 'GPSLongitude', value: 'GPSLongitude' },
									{ name: 'GPSLongitudeRef', value: 'GPSLongitudeRef' },
									{ name: 'GPSAltitude', value: 'GPSAltitude' },
									{ name: 'GPSAltitudeRef', value: 'GPSAltitudeRef' },
								],
							},
							{
