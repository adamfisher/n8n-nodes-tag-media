...
- Python scripts now included in npm package and correctly located at runtime
- Excluded test files from npm distribution to reduce package size
...
[1.0.1]: https://github.com/adamfisher/n8n-nodes-tag-media/releases/tag/v1.0.1
